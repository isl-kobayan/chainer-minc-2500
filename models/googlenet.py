...
class GoogLeNet(chainer.Chain):
    ...
    def __init__(self, labelsize=config.labelsize):
        ...
        super(GoogLeNet, self).add_link('loss3/classifier', F.Linear(1024, self.labelsize))
        ...
        super(GoogLeNet, self).add_link('loss1/classifier', F.Linear(1024, self.labelsize))
        ...
        super(GoogLeNet, self).add_link('loss2/classifier', F.Linear(1024, self.labelsize))
